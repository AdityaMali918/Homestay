  ...
  return (
    ...
    <div className='grid gap-2 grid-cols-[2fr_1fr] rounded-3xl overflow-hidden'>
        ...
        <div className='grid '>
           ...
           {place.photos?.[2] && (
                <img onClick={()=>setShowAllPhotos(true)} className='aspect-square object-cover relative top-2 cursor-pointer' src={"http://localhost:4000/uploads/" + place.photos?.[3]} alt="" />
            )}
           </div>
        </div>
