...
//                                 <img src={"https://airbnbclone-noku.onrender.com/uploads/" + photo} alt="" />
//                             </div>
//                         ))
//                     }
//                 </div>
...
//             {place.photos?.[0] && (
//                 <div>
//                     <img  onClick={()=>setShowAllPhotos(true)} className='aspect-square object-cover cursor-pointer' src={"https://airbnbclone-noku.onrender.com/uploads/" + place.photos?.[0]} alt="" />
//                 </div>
...
//         <div className='grid '>
//             {place.photos?.[1] && (
//                 <img onClick={()=>setShowAllPhotos(true)} className='aspect-square object-cover cursor-pointer' src={"https://airbnbclone-noku.onrender.com/uploads/" + place.photos?.[1]} alt="" />
//             )}

//            <div className='overflow-hidden'>
//            {place.photos?.[2] && (
//                 <img onClick={()=>setShowAllPhotos(true)} className='aspect-square object-cover relative top-2 cursor-pointer' src={"https://airbnbclone-noku.onrender.com/uploads/" + place.photos?.[3]} alt="" />
//             )}
//            </div>
//         </div>
  ...
  if (showAllPhotos) {
    return (
      <div className='absolute inset-0 bg-white min-h-screen'>
        <div className='p-8 grid gap-4 bg-slate-200'>
          <div>
            <h2 className='text-3xl rounded-2xl p-8 mr-36'>Photos of {place.title}</h2>
            <button onClick={() => { setShowAllPhotos(false) }} className='fixed right-12 top-8 flex gap-1 py-2 px-4 rounded-2xl bg-black text-white shadow shadow-black'>
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" dataSlot="icon" className="w-6 h-6">
                <path fillRule="evenodd" d="M5.47 5.47a.75.75 0 0 1 1.06 0L12 10.94l5.47-5.47a.75.75 0 1 1 1.06 1.06L13.06 12l5.47 5.47a.75.75 0 1 1-1.06 1.06L12 13.06l-5.47 5.47a.75.75 0 0 1-1.06-1.06L10.94 12 5.47 6.53a.75.75 0 0 1 0-1.06Z" clipRule="evenodd" />
              </svg>
