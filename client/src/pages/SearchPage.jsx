    ...
    <>
      <form onSubmit={handleSubmit} className="py-3 flex justify-center item-center m-3">
        <input
          ...
          placeholder="search"
        />
        <button className="bg-primary p-2 h-12 text-white rounded-3xl w-12 mr-3 text-center mt-1"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-6">
