  ...
  return (
    <>
      <form onSubmit={handleSubmit}>
        ...
        />
        <button className="bg-primary p-2 w-full text-white rounded-2xl"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
