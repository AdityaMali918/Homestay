    ...
    <>
      <form onSubmit={handleSubmit}>
        <input
          ...
          className=" border my-2 py-2 px-3 rounded-2xl w-1/2"
          placeholder="search"
        />
        <button className="bg-primary p-2 w-1/12 text-white rounded-full"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
