  ...
  return (<div>
    <header className='flex justify-between' >
      ...
      <div className='flex gap-2 border border-gray-300 rounded-full py-2 px-4 shadow-md shadow-gray-300 font-bold'>
        ...
        <div className='border border-l border-gray-300'></div>
        <div>Add guests</div>
        <Link to={'/search'} className='bg-primary text-white rounded-full'><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
